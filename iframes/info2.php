    ...
    <script>
        ...
        fetch(f)
            ...
            .then(data => {
                ...
                iframeTitle.innerHTML = data.iframe2_title;

                var iframeUrl = document.createElement('a');
                iframeUrl.href = data.iframe2_url;
                iframeUrl.innerHTML = "klicken Sie hier für weitere Infos"; // More user-friendly text for the link
